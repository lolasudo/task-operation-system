...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'test@mail.ru', description: 'почтовый адрес' }),
...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'true', description: 'Забанен или нет' }),
...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'За хулиганство', description: 'Причина блокировки' }),
